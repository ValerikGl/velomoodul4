...
<template>
    <main class="bg-[#F8FAFC] px-5 py-10 sm:px-6 lg:py-14">
        <div class="mx-auto max-w-[1280px]">
            ...
            >
                <Link href="/" class="hover:text-[#6D28D9]"
                    >Avaleht</Link
                >
                <ArrowRight :size="16" />
                ...
                >
                            ...
                            <div class="flex h-full flex-col">
                                ...
                                >
                                    <div>
                                        ...
                                        <p
                                            class="mt-3 text-[18px] font-semibold text-[#0F172A]"
                                        >
                                            {{ vehicle.subtitle }}
                                        </p>
                                    </div>
                    ...
                    <section class="mt-9 border-t border-[#E9D9FF] pt-8">
                        <div class="flex items-center justify-between gap-4">
                            <h2
                                class="text-[24px] font-extrabold text-[#0F172A]"
                            >
                        ...
                        <div class="mt-5 grid gap-4 md:grid-cols-3">
                            <div class="relative">
                                <span
                                    class="mb-2 block text-sm font-extrabold text-[#0F172A]"
                                >
                                    Kuupäev
                                </span>
                                ...
                                >
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span
                                            class="text-[18px] font-bold text-[#0F172A]"
                                        >
                                            {{ selectedDate }}
                                        </span>
                                    </div>
                    ...
                    <section class="mt-10 border-t border-[#E9D9FF] pt-8">
                        ...
                        <div class="relative mt-5 overflow-hidden rounded-2xl">
                            <div
                                id="booking-map"
                                class="brand-map h-[280px] w-full"
                            ></div>
                            ...
                            >
                                ...
                                <div>
                                    <h3
                                        class="text-[17px] font-extrabold text-[#0F172A]"
                                    >
                                        Tallinn Kesklinn
                                    </h3>

                                    <p
                                        class="mt-1 text-[16px] font-bold text-[#0F172A]"
                                    >
                                        {{ vehicle.location }}
                                    </p>
                                </div>
                    ...
                    <section class="mt-10 border-t border-[#E9D9FF] pt-8">
                        ...
                        <div class="mt-5 grid gap-4 md:grid-cols-3">
                            <label>
                                <span
                                    class="text-sm font-extrabold text-[#0F172A]"
                                    >Nimi</span
                                >
                                <div
                            ...
                            <label>
                                ...
                                >
                                    ...
                                    <div
                                        class="mr-3 h-6 w-px shrink-0 bg-[#CBD5E1]"
                                    ></div>
                    ...
                    >
                        ...
                        <div class="mt-6 flex gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <p
                                    class="mt-2 text-[18px] font-extrabold text-[#6D28D9]"
                                >
                            ...
                            <div class="space-y-3 text-[14px]">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-extrabold text-[#0F172A]">
                                        {{
                                            (
                                                vehicle.price * selectedDuration
                                            ).toFixed(2)
                                        }}€
                                    </span>
                                </div>
                        ...
                        <div class="mt-8 flex items-end justify-between">
                            <span
                                class="text-[20px] font-extrabold text-[#0F172A]"
                            >
                                Kokku
                            </span>
