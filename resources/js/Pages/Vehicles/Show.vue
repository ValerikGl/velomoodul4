...
const specs = computed(() => [
    ...
    },
    {
        icon: MapPin,
        label: "Sõiduulatus",
        value: props.vehicle.range_km ? `${props.vehicle.range_km} km` : "—",
    },
    {
...
onMounted(async () => {
    ...
    L.marker([59.437, 24.7536], { icon: veloIcon })
        .addTo(map)
        .bindPopup(
            `${props.vehicle.location || "Tallinna Velo punkt"}<br>Narva mnt 5`,
        )
        .openPopup();
});
                ...
                <div>
                    ...
                    <div class="mt-6 flex items-center gap-4">
                        <Link
                            ...
                            class="inline-flex items-center justify-center gap-3 rounded-xl bg-[#6D28D9] px-7 py-4 font-bold text-white shadow-lg transition hover:bg-[#5B21B6]"
                        >
                            <Calendar :size="20" />
                            Broneeri Kohe
                        </Link>
